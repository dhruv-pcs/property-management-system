                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='name' type='text' placeholder='Enter your Name' {...register('name')} />
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='rent' type='tel' placeholder='Enter Rent' {...register('rent')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='available_from' type='date' placeholder='Select Date' {...register('available_from')} />
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='rent_type' type='text' placeholder=' Rent type' {...register('rent_type')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='location' type='text' placeholder='Enter Location' {...register('location')} />
                ...
                <Row className='gx-3 mb-3'>
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='pin_code' type='text' placeholder='Enter your pincode' {...register('pin_code')} />
                    </Form.Group>
                  </Col>
                </Row>
                <Row className='gx-3 mb-3'>
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='property_type' type='text' placeholder='Enter Property Type' {...register('property_type')} />
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='bhk' type='text' placeholder='Enter BHK' {...register('bhk')} />
                ...
                <Row className='gx-3 mb-3'>
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control  id='no_of_bedrooms' type='tel' placeholder='Enter Number of Bedrooms' {...register('no_of_bedrooms')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control  id='no_of_rooms' type='tel' placeholder=' Number of Rooms' {...register('no_of_rooms')} />
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='no_of_kitchen' type='tel' placeholder=' Number of Kitchen' {...register('no_of_kitchen')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='no_of_balconies' type='tel' placeholder=' Number of Balconies' {...register('no_of_balconies')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='property_number' type='text' placeholder='Enter Property Number' {...register('property_number')} />
                ...
                <Row className='gx-3 mb-3'>
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='district' type='text' placeholder='Enter District' {...register('district')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='latitude' type='text' placeholder='Latitude' {...register('latitude')} />
                  ...
                  <Col md={6}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='longitude' type='text' placeholder='Longitude' {...register('longitude')} />
                ...
                <Row className='gx-3 mb-3'>
                  <Col md={12}>
                    <Form.Group className='mb-1'>
                      ...
                      <Form.Control id='description' as='textarea' placeholder='Enter Description' {...register('description')} />
